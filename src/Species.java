public enum Species {
    ...
    SANDSLASH("Sandslash", 28, Type.GROUND, Type.NONE, 75, 100, 110, 45, 55, 65, 163, ExpCurve.MEDIUM),
    ...
    MAGNEMITE("Magnemite", 81, Type.ELECTRIC, Type.STEEL, 25, 35, 70, 95, 55, 45, 89, ExpCurve.MEDIUM),
    MAGNETON("Magneton", 82, Type.ELECTRIC, Type.STEEL, 50, 60, 95, 120, 70, 70, 161, ExpCurve.MEDIUM),
    FARFETCHD("Farfetch'd", 83, Type.NORMAL, Type.FLYING, 52, 65, 55, 58, 62, 60, 94, ExpCurve.MEDIUM),
    ...
    ELECTRODE("Electrode", 101, Type.ELECTRIC, Type.NONE, 60, 50, 70, 80, 80, 140, 150, ExpCurve.MEDIUM),
    ...
    HITMONLEE("Hitmonlee", 106, Type.FIGHTING, Type.NONE, 50, 120, 53, 35, 110, 87, 139, ExpCurve.MEDIUM),
    HITMONCHAN("Hitmonchan", 107, Type.FIGHTING, Type.NONE, 50, 105, 79, 35, 110, 76, 140, ExpCurve.MEDIUM),
    ...
    KANGASKHAN("Kangaskhan", 115, Type.NORMAL, Type.NONE, 105, 95, 80, 40, 80, 90, 175, ExpCurve.MEDIUM),
    ...
    ELECTABUZZ("Electabuzz", 125, Type.ELECTRIC, Type.NONE, 65, 83, 57, 95, 85, 105, 156, ExpCurve.MEDIUM),
    ...
    SLOWKING("Slowking", 199, Type.WATER, Type.PSYCHIC, 95, 75, 80, 100, 110, 30, 164, ExpCurve.MEDIUM),
    ...
    WOBBUFFET("Wobbuffet", 202, Type.PSYCHIC, Type.NONE, 190, 33, 58, 33, 58, 33, 177, ExpCurve.MEDIUM),
    GIRAFARIG("Girafarig", 203, Type.NORMAL, Type.PSYCHIC, 70, 80, 65, 90, 65, 85, 149, ExpCurve.MEDIUM),
    PINECO("Pineco", 204, Type.BUG, Type.NONE, 50, 65, 90, 35, 35, 15, 60, ExpCurve.MEDIUM),
    FORRETRESS("Forretress", 205, Type.BUG, Type.STEEL, 75, 90, 140, 60, 60, 40, 118, ExpCurve.MEDIUM),
    ...
    OCTILLERY("Octillery", 224, Type.WATER, Type.NONE, 75, 105, 75, 105, 75, 45, 164, ExpCurve.MEDIUM),
    ...
    HITMONTOP("Hitmontop", 237, Type.FIGHTING, Type.NONE, 50, 95, 95, 35, 110, 70, 138, ExpCurve.MEDIUM),
